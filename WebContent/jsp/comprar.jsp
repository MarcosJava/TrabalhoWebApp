							    ...
							    <div class="col-md-4">
									  ...
									  <div class="form-group">
									    ...
									    <div class="input-group">
									      ...
									      <input type="text" class="form-control" value="2"  id="valor" placeholder="Amount" readonly="readonly">
									    </div>
									  </div> <!-- end:valor -->
	...
	<div class="row">
		<div class="col-md-12">
		  ...
		  <div class="form-group col-md4">
			...
			<input type="text" class="form-control" name="dtSaida" id="idDtSaida"  value="10/01/1992" readonly/>				
		  </div>
		</div>
	</div><!-- row end -->
